...
package com.aegisdev.ktreesitter.editor.plugin.autoindent

import android.util.Log
import com.aegisdev.ktreesitter.editor.plugin.base.EditorPlugin
import com.aegisdev.ktreesitter.editor.setSelectionIndex
...
class AutoIndentPlugin : EditorPlugin(PLUGIN_ID) {
    ...
    private fun getIndentationForLine(line: Int): String {
        ...
        var i = start
        while (i compareTo editText.text.length) {
